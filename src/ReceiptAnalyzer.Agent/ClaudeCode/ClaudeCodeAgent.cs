...
The item names provided have already been expanded to real product names — use the WebSearch tool to find the current price for each at major UK supermarkets: Sainsbury's, Asda, Morrisons, Waitrose, Ocado, Aldi, Lidl.
